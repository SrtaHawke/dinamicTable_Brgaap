...
const $jscomp$lookupPolyfilledValue = function (l, y) {
    let A = $jscomp.propertyToPolyfillSymbol[y];
...
(function(l) {
    ...
    let u = function(a, b) {
        ...
        this.fnAdjustColumnSizing = function(f) {
            let g = this.api(!0).columns.adjust(),
                k = g.settings()[0],
                m = k.oScroll;
            f === q || f ? g.draw(!1) : ("" !== m.sX || "" !== m.sY) && Ja(k)
        };
        this.fnClearTable = function(f) {
            let g = this.api(!0).clear();
            (f === q || f) && g.draw()
        };
        ...
        this.fnGetData = function(f, g) {
            let k = this.api(!0);
            if (f !== q) {
                let m = f.nodeName ? f.nodeName.toLowerCase() : "";
        ...
        for (let h in u.ext.internal) h && (this[h] = lc(h));
        this.each(function() {
            let f = {},
                g = 1 < e ? ub(f, b, !0) : b,
                k = 0,
            ...
            if ("table" !== this.nodeName.toLowerCase()) ea(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2);
                ...
                for (m = v.length; k < m; k++) {
                    ...
                    if (x.nTable === this || x.nTHead && x.nTHead.parentNode === this || x.nTFoot && x.nTFoot.parentNode === this) {
                        const w = g.bRetrieve !== q ? g.bRetrieve : p.bRetrieve;
                ...
                let r = l.extend(!0, {}, u.models.oSettings, {
                ...
                f = r.asStripeClasses;
                let ba = t.children("tbody").find("tr").eq(0);
                ...
                if (ba.length) {
                    ...
                    l(ba[0]).children("th, td").each(function(I, H) {
                        let fa = r.aoColumns[I];
                        if (fa.mData === I) {
                            let Z = L(H, "sort") || L(H, "order");
                ...
                f = function() {
                    ...
                    let H = t.children("thead");
                    0 === H.length && (H = l("<thead/>").appendTo(t));
                    r.nTHead = H[0];
                    let fa = t.children("tbody");
                    0 === fa.length && (fa = l("<tbody class='tbodyTable'/>").insertAfter(H));
                    r.nTBody = fa[0];
                    H = t.children("tfoot");
    ...
    function la(a) {
        const b = u.defaults.oLanguage,
            c = b.sDecimal;
        c && bb(c);
        if (a) {
            let d = a.sZeroRecords;
    ...
    function Db(a) {
        ...
        if (a === a.aoSearchCols)
            for (let b = 0, c = a.length; b < c; b++) a[b] && P(u.models.oSearch, a[b])
    }
    ...
    function Ia(a, b, c) {
        ...
        if (!b.sWidthOrig) {
            ...
            h = (e.attr("style") || "").match(/width:\s*(\d+[pxem%]+)/);
            h && (b.sWidthOrig = h[1])
        }
    ...
    function Hb(a, b, c, d) {
        let e, h, f, g = a.aoColumns;
        if (b)
            for (e = b.length - 1; 0 <= e; e--) {
                let k = b[e];
                let m = k.target !== q ? k.target : k.targets !== q ? k.targets : k.aTargets;
                Array.isArray(m) || (m = [m]);
                let n = 0;
    ...
    function ia(a, b, c, d) {
        ...
        h._aData = b;
        a.aoData.push(h);
        for (let f = a.aoColumns, g = 0, k = f.length; g < k; g++) f[g].sType = null;
    ...
    function Na(a, b, c) {
        for (let d = -1, e = 0, h = a.length; e < h; e++) a[e] === b ? d = e : a[e] > b && a[e]--; - 1 !== d && c === q && a.splice(d, 1)
    }
    ...
    function Jb(a) {
        ...
        for (b = g.length; k < b; k++) {
            let m = g[k];
            let n = l(m.nTh).addClass(m.sClass);
            h && n.appendTo(c);
    ...
    function Mb(a) {
        ...
        let h = a.sDom.split(""), f, g, k, m, n, p, t = 0;
        for (; t < h.length; t++) {
            f = null;
            g = h[t];
            if ("<" === g) {
        ...
        for (e = b.length; h < e; h++) {
            ...
            for (c = f.firstChild; c;) {
                if ("TD" === c.nodeName.toUpperCase() || "TH" === c.nodeName.toUpperCase()) {
                    let g = 1 * c.getAttribute("colspan");
                    let k = 1 * c.getAttribute("rowspan");
                    g = g && 0 !== g && 1 !== g ? g : 1;
                    k = k && 0 !== k && 1 !== k ? k : 1;
                    let m = 0;
                    for (d = a[h]; d[m];) m++;
    ...
    function Pa(a, b, c) {
        ...
        b = 0;
        for (let e = c.length; b < e; b++)
            for (let h = 0, f = c[b].length; h < f; h++) !c[b][h].unique || d[h] && a.bSortCellsTop || (d[h] = c[b][h].cell);
        return d
    }
    ...
    function Qa(a, b, c) {
        ...
        let h = a.ajax,
            f = a.oInstance,
            g = function (n) {
                let p = a.jqXHR ? a.jqXHR.status : null;
                if (null ===
    ...
    function Tb(a) {
        let b = a.aoColumns,
            ...
            f = [],
            g = oa(a);
        let k = a._iDisplayStart;
        let m = !1 !== d.bPaginate ? a._iDisplayLength : -1;
        const n = function (x, w) {
            f.push({
                name: x,
                value: w
            })
    ...
    function Ob(a) {
        ...
        const m = l("input", b).val(e.sSearch).attr("placeholder", d.sSearchPlaceholder).on("keyup.DT search.DT input.DT paste.DT cut.DT", h ? mb(k, h) : k).on("mouseup", function (n) {
            setTimeout(function () {
                k.call(m[0], n)
            }, 10)
    ...
    function Xb(a) {
        let b = u.ext.search,
            c = a.aiDisplay, d, e, h = 0, f = b.length;
        for (; h < f; h++) {
            let g = [];
            let m = c.length;
            let k = 0;
            for (; k < m; k++) e = c[k], d = a.aoData[e], b[h](a, d._aFilterData, e, d._aData, k) && g.push(e);
            c.length = 0;
            l.merge(c, g)
        }
    }
    ...
    function Vb(a, b, c, d, e, h) {
        e = nb(b, d, e, h);
        let f = a.oPreviousSearch.sSearch,
            g = a.aiDisplayMaster;
        h = [];
    ...
    function Aa(a) {
        let b = a.iInitDisplayStart,
            c = a.aoColumns;
        let d = a.oFeatures;
        let e = a.bDeferLoading;
        if (a.bInitialised) {
            Mb(a);
            Jb(a);
            xa(a, a.aoHeader);
    ...
    function Nb(a) {   //SELECT HERE
        ...
        let f = 0, g = h.length;
        for (; f < g; f++) e[0][f] = new Option("number" ===
        typeof d[f] ? a.fnFormatNumber(d[f]) : d[f], h[f]);
        const k = l("<div><label/></div>").addClass(b.sLength);
    ...
    function Ja(a) {
        ...
        let X = g.scrollHeight > g.clientHeight;
        if (a.scrollBarVis !== X && a.scrollBarVis !== q) a.scrollBarVis = X, sa(a);
            ...
            da(Ba, X);
            da(function(D) {
                const W = y.getComputedStyle ? y.getComputedStyle(D).width : K(l(D).width());
                H.push(D.innerHTML);
                O.push(W)
            }, X);
            da(function(D, W) {
    ...
    function da(a, b, c) {
        for (let d = 0, e = 0, h = b.length, f, g; e < h;) {
            f = b[e].firstChild;
    ...
    function db(a) {
        ...
        if (d || !t && !h && !e && g === na(a) && g === m.length)
            ...
            const r = l("<tr/>").appendTo(g.find("tbody"));
    ...
    function oa(a) {
        let b = [],
            c = a.aoColumns;
        let d = a.aaSortingFixed;
        let e = l.isPlainObject(d);
        let h = [];
        let f = function (n) {
    ...
    function gc(a) {
        ...
        for (; d < e; d++) {
            let h = b[d];
            const f = h.asSorting;
            let g = h.ariaTitle || h.sTitle.replace(/<.*?>/g, "");
            const k = h.nTh;
    ...
    function fc(a, b) {
        ...
        let h, f = u.ext.type.order[c.sType + "-pre"], g = 0, k = a.aoData.length;
        for (; g < k; g++)
    ...
    function tb(a, b, c) {
        let d, e = a.aoColumns;
        a._bLoadingState = !0;
        let h = a._bInitComplete ? new u.Api(a) : null;
        if (b && b.time) {
            let f = F(a, "aoStateLoadParams", "stateLoadParams", [a, b]);
    ...
    function lc(a) {
        return function() {
            const b = [Wa(this[u.ext.iApiIndex])].concat(Array.prototype.slice.call(arguments));
    ...
    let z, J, xb = {},
        ...
        qc = function (a) {
            ...
            let d = a.length;
            let c = 0;
            for (; c < d; c++) a[c] && b.push(a[c]);
            return b
        },
        rc = function (a, b) {
            if (Array.isArray(b))
                for (let c = 0; c < b.length; c++) rc(a, b[c]);
            else a.push(b);
            return a
        },
        sc = function (a, b) {
    ...
    let B = function(a, b) {
        ...
        if (Array.isArray(a))
            for (let e = 0, h = a.length; e < h; e++) d(a[e]);
        else d(a);
        this.context = Oa(c);
        b && l.merge(this, b);
        this.selector = {
    ...
    B.extend = function(a, b, c) {
        if (c.length && b && (b instanceof B || b.__dt_wrapper)) {
            let d, e = function (g, k, m) {
                return function () {
                    let n = k.apply(g, arguments);
    ...
    B.register = z = function(a, b) {
        let g;
        if (Array.isArray(a))
            for (let c = 0, d = a.length; c < d; c++) B.register(a[c], b);
        else {
            let d = a.split(".");
            let e = tc,
                h;
            a = 0;
            for (let c = d.length; a < c; a++) {
                let f = (h = -1 !== d[a].indexOf("()")) ? d[a].replace("()", "") : d[a];
                a: {
                    g = 0;
                    for (let k = e.length; g < k; g++)
                        if (e[g].name === f) {
                            g = e[g];
                            break a
                        } g = null
    ...
    let vc = function(a, b,
        ...
        if ("ssp" === Q(a)) ka(a, b);
            ...
            Qa(a, [], function(h) {
                Ma(a);
                h = za(a, h);
                for (let f = 0, g = h.length; f < g; f++) ia(a, h[f]);
                ka(a, b);
                V(a, !1)
            })
        }
    ...
    z("rows()", function(a, b) {
        ...
        b = Ab(b);
        let c = this.iterator("table", function (d) {
            return Gc(d, a, b)
        }, 1);
        c.selector.rows =
            a;
    ...
    J("rows().ids()", "row().id()", function(a) {
        ...
        let e = c.length;
        for (; d < e; d++)
            for (let h = 0, f = this[d].length; h < f; h++) {
                const g = c[d].rowIdFn(c[d].aoData[this[d][h]]._aData);
                b.push((!0 === a ? "#" : "") + g)
            }
        return new B(c, b)
    });
    J("rows().remove()", "row().remove()", function() {
        ...
        this.iterator("table", function(b) {
            for (let c = 0, d = b.aoData.length; c < d; c++) b.aoData[c].idx = c
        });
        return this
    });
    z("rows.add()", function(a) {
        let b = this.iterator("table", function(d) {
                let e, h = [];
                let f = 0;
    ...
    z("row.add()", function(a) {
        ...
        let b = this.iterator("table", function (c) {
    ...
    l(A).on("plugin-init.dt", function(a, b) {
        ...
        a.on("stateSaveParams", function(d, e, h) {
            ...
            d = e.rowIdFn;
            e = e.aoData;
            for (; g < e.length; g++) e[g]._detailsShow && f.push("#" + d(e[g]._aData));
            h.childRows = f
        });
        let c = a.state.loaded();
    ...
    let Hc = function(a, b, c, d) {
            let e = [],
                h = function (f, g) {
                    if (Array.isArray(f) || f instanceof l)
                        for (let k = 0, m = f.length; k < m; k++) h(f[k], g);
    ...
    let Jc = /^([^:]+):(name|visIdx|visible)$/,
        yc = function(a, b, c, d, e) {
            c = [];
            d = 0;
            for (let h = e.length; d < h; d++) c.push(T(a, e[d], b));
            return c
        },
        Kc = function(a, b, c) {
            let d = a.aoColumns,
            ...
            return zb("column", b, function(f) {
                ...
                let m = "string" === typeof f ? f.match(Jc) : "";
                if (m) switch (m[2]) {
                    case "visIdx":
                    case "visible":
                        g = parseInt(m[1], 10);
                        if (0 > g) {
                            let n = l.map(d, function (p, t) {
    ...
    J("columns().visible()", "column().visible()", function(a, b) {
        let c = this,
            d = this.iterator("column", function(e, h) {
                ...
                if (a !== q && g.bVisible !== a) {
                    if (a) {
                        let n = l.inArray(!0, U(f, "bVisible"), h + 1);
                        f = 0;
    ...
    u.versionCheck = u.fnVersionCheck = function(a) {
        let b = u.version.split(".");
        a = a.split(".");
        for (let c, d, e = 0, h = a.length; e < h; e++)
    ...
    u.isDataTable = u.fnIsDataTable = function(a) {
        ...
        l.each(u.settings, function(d, e) {
            ...
            let h = e.nScrollFoot ? l("table", e.nScrollFoot)[0] : null;
    ...
    u.tables = u.fnTables = function(a) {
        ...
        let c = l.map(u.settings, function (d) {
    ...
    u.defaults = {
        ...
        aaSortingFixed: [],
        ajax: null,
        aLengthMenu: [10, 25, 30, 50, 100], //Change options list
        aoColumns: null,
        aoColumnDefs: null,
        aoSearchCols: [],
        ...
        iStateDuration: 7200,
        iDeferLoading: null,
        iDisplayLength: 10, //Change value list
        iDisplayStart: 0,
        iTabIndex: 0,
        oClasses: {},
        oLanguage: {
            ...
            sEmptyTable: "Nenhum dado encontrado para compor a tabela",
            sInfo: " _START_ a _END_ de _TOTAL_ Itens",
            sInfoEmpty: "Mostrando 0 a 0 de 0 entradas",
            sInfoFiltered: "(Filtrado de _MAX_ itens ao todo)",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
    ...
    l.extend(!0, u.ext.renderer, {
        pageButton: {
            _: function(a, b, c, d, e, h) {
                const v = l(b).find(A.activeElement).data("dt-idx");
                let f = a.oClasses,
    ...
    let $a = function(a) {
        ...
        Ac = ".";
    if (Intl) try {
        let Ha = (new Intl.NumberFormat).formatToParts(100000.1), ra = 0;
        for (; ra < Ha.length; ra++) "group" === Ha[ra].type ? zc = Ha[ra].value : "decimal" === Ha[ra].type && (Ac = Ha[ra].value)
    } catch (a) {}
    u.datetime = function(a, b) {
        let c = "datetime-detect-" + a;
        b || (b = "en");
